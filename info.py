...
API_ID = int(environ.get('API_ID', '1220805')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'b01d18cba6e1b7f206cc2d3d415ceed1')  # API Hash from my.telegram.org
...
PICS = (environ.get('PICS', 'https://files.catbox.moe/2wbsln.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://files.catbox.moe/2wbsln.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://files.catbox.moe/2wbsln.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://files.catbox.moe/l3nsdz.jpeg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://files.catbox.moe/5ddxyt.jpg https://files.catbox.moe/5ddxyt.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '865764383').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001847367198 -1001316843095 -1001372110754 -1002800700342').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001734896248'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1001734896248'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002823015135'))  # Premium logs channel id
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1001759223130")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1001759223130")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://t.me/keepmessage_bot')    # QR code image for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Infinitymovies:rockstaryohan@filterbot.c43yufi.mongodb.net/?retryWrites=true&w=majority&appName=Filterbot")  # MongoDB URI for the database
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1001847367198'))  # Notification of sent to your channel
...
TMDB_API_KEY = environ.get('TMDB_API_KEY', '81e9ffe477aa863b8748d574c8d56b65') # preffer to use your own tmdb API Key get it from https://www.themoviedb.org/settings/api
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002765580351')) #Verification Channel Id 
...
SHORTENER_API = environ.get("SHORTENER_API", "10815cdac1c807a7b1c02b7cbb274e6a2bc1f75e") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "gyanilinks.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "10815cdac1c807a7b1c02b7cbb274e6a2bc1f75e")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "gyanilinks.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "10815cdac1c807a7b1c02b7cbb274e6a2bc1f75e")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "gyanilinks.com") # Shortener website for third website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/infinitymoviesgroup') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/keepmessage_bot') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Infinity_movies2') # Update channel link for the bot
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '865764383 1488343559').split()]
...
LANGUAGES = {"ᴛᴇʟᴜɢᴜ":"tel","ᴛᴀᴍɪʟ":"tam","ᴇɴɢʟɪsʜ":"eng","ʜɪɴᴅɪ":"hin","ᴍᴀʟᴀʏᴀʟᴀᴍ":"mal","ᴋᴀɴɴᴀᴅᴀ":"kan","ɢᴜᴊᴀʀᴀᴛɪ":"guj","ᴍᴀʀᴀᴛʜɪ":"mar","ᴘᴜɴᴊᴀʙɪ":"pun"}
